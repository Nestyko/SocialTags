...
-- Tiempo de generación: 03-08-2016 a las 05:53:13
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `agregarAmigo` (IN `correo_usuario` INT(100), IN `correo_usuario1` INT(100))  BEGIN  
...
--
-- Volcado de datos para la tabla `usuario_has_usuario`
--

INSERT INTO `usuario_has_usuario` (`usuario`, `usuario1`) VALUES
(25, 26);
