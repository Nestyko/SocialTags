...
if (isset($_POST[$MM_flag])) {
  $MM_dupKeyRedirect="errortag.php";
  $loginUsername = $_POST['tag'];
  $LoginRS__query = sprintf("SELECT tag FROM tag WHERE tag=%s", GetSQLValueString($loginUsername, "text"));
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "frm1")) {
  $insertSQL = sprintf("INSERT INTO tag (tag) VALUES (%s)",
...
$tag =  $_POST['tag'];
 ...
 $insertSQL = sprintf("CALL crearTag('$tag')");
 mysql_select_db($database_badell, $badell);
  $Result1 = mysql_query($insertSQL, $badell) or die(mysql_error());
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    Crea Tendencia
      <input type="text" class="form-control" name="tag" value="#" size="32">
   <input type="submit" class="btn btn-danger" value="Crear tag">
