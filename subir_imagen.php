...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "form1")) {
    ...
    $image_path = "Img_Publicacion/".$nombre_archivo;
	move_uploaded_file($_FILES['userfile']['tmp_name'], $image_path);
	
	?>
  
    <script>
		opener.document.form1.img.value="<?php echo $nombre_archivo; ?>";
		self.close();
	</script>
    <?php
}
